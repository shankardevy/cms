defmodule CmsWeb.ArticleLiveTest do
  use CmsWeb.ConnCase
  ...
  @create_attrs %{components: [], title: "some title"}
  @update_attrs %{components: [], title: "some updated title"}
  @invalid_attrs %{components: nil, title: nil}
